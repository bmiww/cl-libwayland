...
(DEFMETHOD CL-WL:DESTROY :AFTER ((DISPATCH DISPATCH))
  ...
  (LET ((RESOURCE-PTR (WL_DISPLAY-PTR DISPATCH)))
    (REMHASH (POINTER-ADDRESS RESOURCE-PTR) CL-WL::*RESOURCE-TRACKER*)))
...
(DEFMETHOD SHARED-INITIALIZE :AFTER ((INSTANCE DISPATCH) SLOT-NAMES &KEY ID)
  ...
  (UNLESS (WL_REGISTRY-ID INSTANCE)
    (SETF (WL_REGISTRY-ID INSTANCE) ID)
    (LET* ((RESOURCE
            (CL-WL::CREATE-RESOURCE (CL-WL:PTR (CL-WL:CLIENT INSTANCE))
                                    *INTERFACE* (VERSION INSTANCE)
                                    (WL_REGISTRY-ID INSTANCE))))
      (SETF (GETHASH (POINTER-ADDRESS RESOURCE) CL-WL::*RESOURCE-TRACKER*)
              INSTANCE)
...
(DEFMETHOD SHARED-INITIALIZE :AFTER ((INSTANCE DISPATCH) SLOT-NAMES &KEY ID)
  ...
  (UNLESS (WL_CALLBACK-ID INSTANCE)
    (SETF (WL_CALLBACK-ID INSTANCE) ID)
    (LET* ((RESOURCE
            (CL-WL::CREATE-RESOURCE (CL-WL:PTR (CL-WL:CLIENT INSTANCE))
                                    *INTERFACE* (VERSION INSTANCE)
                                    (WL_CALLBACK-ID INSTANCE))))
      (SETF (GETHASH (POINTER-ADDRESS RESOURCE) CL-WL::*RESOURCE-TRACKER*)
              INSTANCE)
...
(DEFMETHOD SHARED-INITIALIZE :AFTER ((INSTANCE DISPATCH) SLOT-NAMES &KEY ID)
  ...
  (UNLESS (WL_COMPOSITOR-ID INSTANCE)
    (SETF (WL_COMPOSITOR-ID INSTANCE) ID)
    (LET* ((RESOURCE
            (CL-WL::CREATE-RESOURCE (CL-WL:PTR (CL-WL:CLIENT INSTANCE))
                                    *INTERFACE* (VERSION INSTANCE)
                                    (WL_COMPOSITOR-ID INSTANCE))))
      (SETF (GETHASH (POINTER-ADDRESS RESOURCE) CL-WL::*RESOURCE-TRACKER*)
              INSTANCE)
...
(DEFMETHOD SHARED-INITIALIZE :AFTER ((INSTANCE DISPATCH) SLOT-NAMES &KEY ID)
  ...
  (UNLESS (WL_SHM_POOL-ID INSTANCE)
    (SETF (WL_SHM_POOL-ID INSTANCE) ID)
    (LET* ((RESOURCE
            (CL-WL::CREATE-RESOURCE (CL-WL:PTR (CL-WL:CLIENT INSTANCE))
                                    *INTERFACE* (VERSION INSTANCE)
                                    (WL_SHM_POOL-ID INSTANCE))))
      (SETF (GETHASH (POINTER-ADDRESS RESOURCE) CL-WL::*RESOURCE-TRACKER*)
              INSTANCE)
...
(DEFMETHOD SHARED-INITIALIZE :AFTER ((INSTANCE DISPATCH) SLOT-NAMES &KEY ID)
  ...
  (UNLESS (WL_BUFFER-ID INSTANCE)
    (SETF (WL_BUFFER-ID INSTANCE) ID)
    (LET* ((RESOURCE
            (CL-WL::CREATE-RESOURCE (CL-WL:PTR (CL-WL:CLIENT INSTANCE))
                                    *INTERFACE* (VERSION INSTANCE)
                                    (WL_BUFFER-ID INSTANCE))))
      (SETF (GETHASH (POINTER-ADDRESS RESOURCE) CL-WL::*RESOURCE-TRACKER*)
              INSTANCE)
...
(DEFMETHOD SHARED-INITIALIZE :AFTER ((INSTANCE DISPATCH) SLOT-NAMES &KEY ID)
  ...
  (UNLESS (WL_DATA_OFFER-ID INSTANCE)
    (SETF (WL_DATA_OFFER-ID INSTANCE) ID)
    (LET* ((RESOURCE
            (CL-WL::CREATE-RESOURCE (CL-WL:PTR (CL-WL:CLIENT INSTANCE))
                                    *INTERFACE* (VERSION INSTANCE)
                                    (WL_DATA_OFFER-ID INSTANCE))))
      (SETF (GETHASH (POINTER-ADDRESS RESOURCE) CL-WL::*RESOURCE-TRACKER*)
              INSTANCE)
...
(DEFMETHOD SHARED-INITIALIZE :AFTER ((INSTANCE DISPATCH) SLOT-NAMES &KEY ID)
  ...
  (UNLESS (WL_DATA_SOURCE-ID INSTANCE)
    (SETF (WL_DATA_SOURCE-ID INSTANCE) ID)
    (LET* ((RESOURCE
            (CL-WL::CREATE-RESOURCE (CL-WL:PTR (CL-WL:CLIENT INSTANCE))
                                    *INTERFACE* (VERSION INSTANCE)
...
(DEFMETHOD SHARED-INITIALIZE :AFTER ((INSTANCE DISPATCH) SLOT-NAMES &KEY ID)
  ...
  (UNLESS (WL_DATA_DEVICE-ID INSTANCE)
    (SETF (WL_DATA_DEVICE-ID INSTANCE) ID)
    (LET* ((RESOURCE
            (CL-WL::CREATE-RESOURCE (CL-WL:PTR (CL-WL:CLIENT INSTANCE))
                                    *INTERFACE* (VERSION INSTANCE)
...
(DEFMETHOD SHARED-INITIALIZE :AFTER ((INSTANCE DISPATCH) SLOT-NAMES &KEY ID)
  ...
  (UNLESS (WL_DATA_DEVICE_MANAGER-ID INSTANCE)
    (SETF (WL_DATA_DEVICE_MANAGER-ID INSTANCE) ID)
    (LET* ((RESOURCE
            (CL-WL::CREATE-RESOURCE (CL-WL:PTR (CL-WL:CLIENT INSTANCE))
                                    *INTERFACE* (VERSION INSTANCE)
                                    (WL_DATA_DEVICE_MANAGER-ID
...
(DEFMETHOD SHARED-INITIALIZE :AFTER ((INSTANCE DISPATCH) SLOT-NAMES &KEY ID)
  ...
  (UNLESS (WL_SHELL-ID INSTANCE)
    (SETF (WL_SHELL-ID INSTANCE) ID)
    (LET* ((RESOURCE
            (CL-WL::CREATE-RESOURCE (CL-WL:PTR (CL-WL:CLIENT INSTANCE))
                                    *INTERFACE* (VERSION INSTANCE)
                                    (WL_SHELL-ID INSTANCE))))
      (SETF (GETHASH (POINTER-ADDRESS RESOURCE) CL-WL::*RESOURCE-TRACKER*)
              INSTANCE)
...
(DEFMETHOD SHARED-INITIALIZE :AFTER ((INSTANCE DISPATCH) SLOT-NAMES &KEY ID)
  ...
  (UNLESS (WL_SHELL_SURFACE-ID INSTANCE)
    (SETF (WL_SHELL_SURFACE-ID INSTANCE) ID)
    (LET* ((RESOURCE
            (CL-WL::CREATE-RESOURCE (CL-WL:PTR (CL-WL:CLIENT INSTANCE))
                                    *INTERFACE* (VERSION INSTANCE)
                                    (WL_SHELL_SURFACE-ID
...
(DEFMETHOD SHARED-INITIALIZE :AFTER ((INSTANCE DISPATCH) SLOT-NAMES &KEY ID)
  ...
  (UNLESS (WL_SURFACE-ID INSTANCE)
    (SETF (WL_SURFACE-ID INSTANCE) ID)
    (LET* ((RESOURCE
            (CL-WL::CREATE-RESOURCE (CL-WL:PTR (CL-WL:CLIENT INSTANCE))
                                    *INTERFACE* (VERSION INSTANCE)
                                    (WL_SURFACE-ID INSTANCE))))
      (SETF (GETHASH (POINTER-ADDRESS RESOURCE) CL-WL::*RESOURCE-TRACKER*)
              INSTANCE)
...
(DEFMETHOD SHARED-INITIALIZE :AFTER ((INSTANCE DISPATCH) SLOT-NAMES &KEY ID)
  ...
  (UNLESS (WL_POINTER-ID INSTANCE)
    (SETF (WL_POINTER-ID INSTANCE) ID)
    (LET* ((RESOURCE
            (CL-WL::CREATE-RESOURCE (CL-WL:PTR (CL-WL:CLIENT INSTANCE))
                                    *INTERFACE* (VERSION INSTANCE)
                                    (WL_POINTER-ID INSTANCE))))
      (SETF (GETHASH (POINTER-ADDRESS RESOURCE) CL-WL::*RESOURCE-TRACKER*)
              INSTANCE)
...
(DEFMETHOD SHARED-INITIALIZE :AFTER ((INSTANCE DISPATCH) SLOT-NAMES &KEY ID)
  ...
  (UNLESS (WL_KEYBOARD-ID INSTANCE)
    (SETF (WL_KEYBOARD-ID INSTANCE) ID)
    (LET* ((RESOURCE
            (CL-WL::CREATE-RESOURCE (CL-WL:PTR (CL-WL:CLIENT INSTANCE))
                                    *INTERFACE* (VERSION INSTANCE)
                                    (WL_KEYBOARD-ID INSTANCE))))
      (SETF (GETHASH (POINTER-ADDRESS RESOURCE) CL-WL::*RESOURCE-TRACKER*)
              INSTANCE)
...
(DEFMETHOD SHARED-INITIALIZE :AFTER ((INSTANCE DISPATCH) SLOT-NAMES &KEY ID)
  ...
  (UNLESS (WL_TOUCH-ID INSTANCE)
    (SETF (WL_TOUCH-ID INSTANCE) ID)
    (LET* ((RESOURCE
            (CL-WL::CREATE-RESOURCE (CL-WL:PTR (CL-WL:CLIENT INSTANCE))
                                    *INTERFACE* (VERSION INSTANCE)
                                    (WL_TOUCH-ID INSTANCE))))
      (SETF (GETHASH (POINTER-ADDRESS RESOURCE) CL-WL::*RESOURCE-TRACKER*)
              INSTANCE)
...
(DEFMETHOD SHARED-INITIALIZE :AFTER ((INSTANCE DISPATCH) SLOT-NAMES &KEY ID)
  ...
  (UNLESS (WL_OUTPUT-ID INSTANCE)
    (SETF (WL_OUTPUT-ID INSTANCE) ID)
    (LET* ((RESOURCE
            (CL-WL::CREATE-RESOURCE (CL-WL:PTR (CL-WL:CLIENT INSTANCE))
                                    *INTERFACE* (VERSION INSTANCE)
                                    (WL_OUTPUT-ID INSTANCE))))
      (SETF (GETHASH (POINTER-ADDRESS RESOURCE) CL-WL::*RESOURCE-TRACKER*)
              INSTANCE)
  ...
  (LET ((ARG-LIST (FOREIGN-ALLOC '(:UNION WL_ARGUMENT) :COUNT 8)))
    ...
    (SETF (FOREIGN-SLOT-VALUE
           ...
           '(:UNION CL-WL.FFI:WL_ARGUMENT) 'WL-FFI::S)
            MAKE)
    (SETF (FOREIGN-SLOT-VALUE
           (MEM-AREF ARG-LIST '(:UNION CL-WL.FFI:WL_ARGUMENT) 6)
           '(:UNION CL-WL.FFI:WL_ARGUMENT) 'WL-FFI::S)
            MODEL)
    (SETF (FOREIGN-SLOT-VALUE
...
(DEFMETHOD SHARED-INITIALIZE :AFTER ((INSTANCE DISPATCH) SLOT-NAMES &KEY ID)
  ...
  (UNLESS (WL_REGION-ID INSTANCE)
    (SETF (WL_REGION-ID INSTANCE) ID)
    (LET* ((RESOURCE
            (CL-WL::CREATE-RESOURCE (CL-WL:PTR (CL-WL:CLIENT INSTANCE))
                                    *INTERFACE* (VERSION INSTANCE)
                                    (WL_REGION-ID INSTANCE))))
      (SETF (GETHASH (POINTER-ADDRESS RESOURCE) CL-WL::*RESOURCE-TRACKER*)
              INSTANCE)
...
(DEFMETHOD SHARED-INITIALIZE :AFTER ((INSTANCE DISPATCH) SLOT-NAMES &KEY ID)
  ...
  (UNLESS (WL_SUBCOMPOSITOR-ID INSTANCE)
    (SETF (WL_SUBCOMPOSITOR-ID INSTANCE) ID)
    (LET* ((RESOURCE
            (CL-WL::CREATE-RESOURCE (CL-WL:PTR (CL-WL:CLIENT INSTANCE))
                                    *INTERFACE* (VERSION INSTANCE)
                                    (WL_SUBCOMPOSITOR-ID
...
(DEFMETHOD SHARED-INITIALIZE :AFTER ((INSTANCE DISPATCH) SLOT-NAMES &KEY ID)
  ...
  (UNLESS (WL_SUBSURFACE-ID INSTANCE)
    (SETF (WL_SUBSURFACE-ID INSTANCE) ID)
    (LET* ((RESOURCE
            (CL-WL::CREATE-RESOURCE (CL-WL:PTR (CL-WL:CLIENT INSTANCE))
                                    *INTERFACE* (VERSION INSTANCE)
                                    (WL_SUBSURFACE-ID INSTANCE))))
      (SETF (GETHASH (POINTER-ADDRESS RESOURCE) CL-WL::*RESOURCE-TRACKER*)
              INSTANCE)
