...
(DEFMETHOD CL-WL:DESTROY :AFTER ((DISPATCH DISPATCH))
  ...
  (LET ((RESOURCE-PTR (XDG_WM_BASE-PTR DISPATCH)))
...
(DEFMETHOD CL-WL:DESTROY :AFTER ((DISPATCH DISPATCH))
  ...
  (WHEN (CL-WL::DESTROY-CALLBACK DISPATCH)
    (LOOP FOR CALLBACK IN (CL-WL::DESTROY-CALLBACK DISPATCH)
          DO (FUNCALL CALLBACK DISPATCH)))
  (LET ((RESOURCE-PTR (XDG_POSITIONER-PTR DISPATCH)))
    (REMHASH (POINTER-ADDRESS RESOURCE-PTR) CL-WL::*RESOURCE-TRACKER*)))
...
(DEFMETHOD SHARED-INITIALIZE :AFTER ((INSTANCE DISPATCH) SLOT-NAMES &KEY ID)
  ...
  (UNLESS (XDG_POSITIONER-ID INSTANCE)
    (SETF (XDG_POSITIONER-ID INSTANCE) ID)
    (LET* ((RESOURCE
            (CL-WL::CREATE-RESOURCE (CL-WL:PTR (CL-WL:CLIENT INSTANCE))
                                    *INTERFACE* (VERSION INSTANCE)
...
(DEFMETHOD CL-WL:DESTROY :AFTER ((DISPATCH DISPATCH))
  ...
  (WHEN (CL-WL::DESTROY-CALLBACK DISPATCH)
    (LOOP FOR CALLBACK IN (CL-WL::DESTROY-CALLBACK DISPATCH)
          DO (FUNCALL CALLBACK DISPATCH)))
  (LET ((RESOURCE-PTR (XDG_SURFACE-PTR DISPATCH)))
    (REMHASH (POINTER-ADDRESS RESOURCE-PTR) CL-WL::*RESOURCE-TRACKER*)))
...
(DEFMETHOD SHARED-INITIALIZE :AFTER ((INSTANCE DISPATCH) SLOT-NAMES &KEY ID)
  ...
  (UNLESS (XDG_SURFACE-ID INSTANCE)
    (SETF (XDG_SURFACE-ID INSTANCE) ID)
    (LET* ((RESOURCE
            (CL-WL::CREATE-RESOURCE (CL-WL:PTR (CL-WL:CLIENT INSTANCE))
                                    *INTERFACE* (VERSION INSTANCE)
                                    (XDG_SURFACE-ID INSTANCE))))
      (SETF (GETHASH (POINTER-ADDRESS RESOURCE) CL-WL::*RESOURCE-TRACKER*)
              INSTANCE)
...
(DEFMETHOD CL-WL:DESTROY :AFTER ((DISPATCH DISPATCH))
  ...
  (WHEN (CL-WL::DESTROY-CALLBACK DISPATCH)
    (LOOP FOR CALLBACK IN (CL-WL::DESTROY-CALLBACK DISPATCH)
          DO (FUNCALL CALLBACK DISPATCH)))
  (LET ((RESOURCE-PTR (XDG_TOPLEVEL-PTR DISPATCH)))
    (REMHASH (POINTER-ADDRESS RESOURCE-PTR) CL-WL::*RESOURCE-TRACKER*)))
...
(DEFMETHOD SHARED-INITIALIZE :AFTER ((INSTANCE DISPATCH) SLOT-NAMES &KEY ID)
  ...
  (UNLESS (XDG_TOPLEVEL-ID INSTANCE)
    (SETF (XDG_TOPLEVEL-ID INSTANCE) ID)
    (LET* ((RESOURCE
            (CL-WL::CREATE-RESOURCE (CL-WL:PTR (CL-WL:CLIENT INSTANCE))
                                    *INTERFACE* (VERSION INSTANCE)
                                    (XDG_TOPLEVEL-ID INSTANCE))))
      (SETF (GETHASH (POINTER-ADDRESS RESOURCE) CL-WL::*RESOURCE-TRACKER*)
              INSTANCE)
...
(DEFMETHOD CL-WL:DESTROY :AFTER ((DISPATCH DISPATCH))
  ...
  (WHEN (CL-WL::DESTROY-CALLBACK DISPATCH)
    (LOOP FOR CALLBACK IN (CL-WL::DESTROY-CALLBACK DISPATCH)
          DO (FUNCALL CALLBACK DISPATCH)))
  (LET ((RESOURCE-PTR (XDG_POPUP-PTR DISPATCH)))
    (REMHASH (POINTER-ADDRESS RESOURCE-PTR) CL-WL::*RESOURCE-TRACKER*)))
...
(DEFMETHOD SHARED-INITIALIZE :AFTER ((INSTANCE DISPATCH) SLOT-NAMES &KEY ID)
  ...
  (UNLESS (XDG_POPUP-ID INSTANCE)
    (SETF (XDG_POPUP-ID INSTANCE) ID)
    (LET* ((RESOURCE
            (CL-WL::CREATE-RESOURCE (CL-WL:PTR (CL-WL:CLIENT INSTANCE))
                                    *INTERFACE* (VERSION INSTANCE)
                                    (XDG_POPUP-ID INSTANCE))))
      (SETF (GETHASH (POINTER-ADDRESS RESOURCE) CL-WL::*RESOURCE-TRACKER*)
              INSTANCE)
