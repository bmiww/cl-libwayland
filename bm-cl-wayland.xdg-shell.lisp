...
(DEFVAR *REQUESTS*
  (LET ((REQUESTS (CFFI:FOREIGN-ALLOC '(:STRUCT WL_MESSAGE) 4)))
    ((LET ((INTERFACE-ARRAY
            (CFFI:FOREIGN-ALLOC '(:POINTER (:POINTER :VOID)) 4))))
...
(SETF (FOREIGN-SLOT-VALUE INTERFACE '(:STRUCT INTERFACE) 'REQUEST-COUNT) 4)

(SETF (FOREIGN-SLOT-VALUE INTERFACE '(:STRUCT INTERFACE) 'REQUESTS) *REQUESTS*)

(SETF (FOREIGN-SLOT-VALUE INTERFACE '(:STRUCT INTERFACE) 'EVENT-COUNT) 1)
...
(DEFVAR *REQUESTS*
  (LET ((REQUESTS (CFFI:FOREIGN-ALLOC '(:STRUCT WL_MESSAGE) 10)))
    ((LET ((INTERFACE-ARRAY
            (CFFI:FOREIGN-ALLOC '(:POINTER (:POINTER :VOID)) 10))))
     (SETF (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'NAME)
             (FOREIGN-STRING-ALLOC (NAME REQUEST))
           (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'SIGNATURE)
             (FOREIGN-STRING-ALLOC "")
    ...
    ((LET ((INTERFACE-ARRAY
     ...
     (SETF (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'NAME)
             (FOREIGN-STRING-ALLOC (NAME REQUEST))
           (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'SIGNATURE)
             (FOREIGN-STRING-ALLOC "iNILiNILiNILiNIL")
           (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'TYPES)
             INTERFACE-ARRAY))
    ((LET ((INTERFACE-ARRAY
            (CFFI:FOREIGN-ALLOC '(:POINTER (:POINTER :VOID)) 10)))
    ...
    ((LET ((INTERFACE-ARRAY
     ...
     (SETF (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'NAME)
             (FOREIGN-STRING-ALLOC (NAME REQUEST))
           (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'SIGNATURE)
             (FOREIGN-STRING-ALLOC "i3NILi3NIL")
           (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'TYPES)
             INTERFACE-ARRAY))
    ((LET ((INTERFACE-ARRAY
            (CFFI:FOREIGN-ALLOC '(:POINTER (:POINTER :VOID)) 10)))
...
(SETF (FOREIGN-SLOT-VALUE INTERFACE '(:STRUCT INTERFACE) 'REQUEST-COUNT) 10)

(SETF (FOREIGN-SLOT-VALUE INTERFACE '(:STRUCT INTERFACE) 'REQUESTS) *REQUESTS*)

(SETF (FOREIGN-SLOT-VALUE INTERFACE '(:STRUCT INTERFACE) 'EVENT-COUNT) 0)
...
(SETF (FOREIGN-SLOT-VALUE INTERFACE '(:STRUCT INTERFACE) 'SET_PARENT_CONFIGURE)
...
(DEFVAR *REQUESTS*
  (LET ((REQUESTS (CFFI:FOREIGN-ALLOC '(:STRUCT WL_MESSAGE) 5)))
    ((LET ((INTERFACE-ARRAY
            (CFFI:FOREIGN-ALLOC '(:POINTER (:POINTER :VOID)) 5))))
     (SETF (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'NAME)
             (FOREIGN-STRING-ALLOC (NAME REQUEST))
           (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'SIGNATURE)
             (FOREIGN-STRING-ALLOC "")
    ...
    ((LET ((INTERFACE-ARRAY
     ...
     (SETF (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'NAME)
             (FOREIGN-STRING-ALLOC (NAME REQUEST))
           (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'SIGNATURE)
             (FOREIGN-STRING-ALLOC "nNILo?NILoNIL")
           (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'TYPES)
             INTERFACE-ARRAY))
    ((LET ((INTERFACE-ARRAY
            (CFFI:FOREIGN-ALLOC '(:POINTER (:POINTER :VOID)) 5)))
...
(SETF (FOREIGN-SLOT-VALUE INTERFACE '(:STRUCT INTERFACE) 'REQUEST-COUNT) 5)
...
(SETF (FOREIGN-SLOT-VALUE INTERFACE '(:STRUCT INTERFACE) 'SET_WINDOW_GEOMETRY)
...
(DEFVAR *REQUESTS*
  (LET ((REQUESTS (CFFI:FOREIGN-ALLOC '(:STRUCT WL_MESSAGE) 14)))
    ((LET ((INTERFACE-ARRAY
            (CFFI:FOREIGN-ALLOC '(:POINTER (:POINTER :VOID)) 14))))
     (SETF (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'NAME)
             (FOREIGN-STRING-ALLOC (NAME REQUEST))
           (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'SIGNATURE)
             (FOREIGN-STRING-ALLOC "")
    ...
    ((LET ((INTERFACE-ARRAY
     ...
     (SETF (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'NAME)
             (FOREIGN-STRING-ALLOC (NAME REQUEST))
           (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'SIGNATURE)
             (FOREIGN-STRING-ALLOC "oNILuNILiNILiNIL")
           (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'TYPES)
             INTERFACE-ARRAY))
    ((LET ((INTERFACE-ARRAY
            (CFFI:FOREIGN-ALLOC '(:POINTER (:POINTER :VOID)) 14)))
    ...
    ((LET ((INTERFACE-ARRAY
     ...
     (SETF (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'NAME)
             (FOREIGN-STRING-ALLOC (NAME REQUEST))
           (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'SIGNATURE)
             (FOREIGN-STRING-ALLOC "oNILuNILuNIL")
           (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'TYPES)
             INTERFACE-ARRAY))
    ((LET ((INTERFACE-ARRAY
            (CFFI:FOREIGN-ALLOC '(:POINTER (:POINTER :VOID)) 14)))
...
(SETF (FOREIGN-SLOT-VALUE INTERFACE '(:STRUCT INTERFACE) 'REQUEST-COUNT) 14)

(SETF (FOREIGN-SLOT-VALUE INTERFACE '(:STRUCT INTERFACE) 'REQUESTS) *REQUESTS*)

(SETF (FOREIGN-SLOT-VALUE INTERFACE '(:STRUCT INTERFACE) 'EVENT-COUNT) 4)
...
(DEFVAR *REQUESTS*
  (LET ((REQUESTS (CFFI:FOREIGN-ALLOC '(:STRUCT WL_MESSAGE) 3)))
    ((LET ((INTERFACE-ARRAY
            (CFFI:FOREIGN-ALLOC '(:POINTER (:POINTER :VOID)) 3))))
     (SETF (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'NAME)
             (FOREIGN-STRING-ALLOC (NAME REQUEST))
           (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'SIGNATURE)
             (FOREIGN-STRING-ALLOC "")
    ...
    ((LET ((INTERFACE-ARRAY
     ...
     (SETF (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'NAME)
             (FOREIGN-STRING-ALLOC (NAME REQUEST))
           (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'SIGNATURE)
             (FOREIGN-STRING-ALLOC "o3NILu3NIL")
           (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'TYPES)
             INTERFACE-ARRAY))
    REQUESTS))
...
(SETF (FOREIGN-SLOT-VALUE INTERFACE '(:STRUCT INTERFACE) 'REQUEST-COUNT) 3)

(SETF (FOREIGN-SLOT-VALUE INTERFACE '(:STRUCT INTERFACE) 'REQUESTS) *REQUESTS*)

(SETF (FOREIGN-SLOT-VALUE INTERFACE '(:STRUCT INTERFACE) 'EVENT-COUNT) 3)
