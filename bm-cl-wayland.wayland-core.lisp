...
(DEFVAR *REQUESTS*
  (LET ((REQUESTS (CFFI:FOREIGN-ALLOC '(:STRUCT WL_MESSAGE) :COUNT 1)))
    (LET ((INTERFACE-ARRAY
...
(DEFVAR *REQUESTS*
  (LET ((REQUESTS (CFFI:FOREIGN-ALLOC '(:STRUCT WL_MESSAGE) :COUNT 0)))
    REQUESTS))
...
(DEFVAR *REQUESTS*
  (LET ((REQUESTS (CFFI:FOREIGN-ALLOC '(:STRUCT WL_MESSAGE) :COUNT 3)))
    (LET ((INTERFACE-ARRAY
...
(DEFVAR *REQUESTS*
  (LET ((REQUESTS (CFFI:FOREIGN-ALLOC '(:STRUCT WL_MESSAGE) :COUNT 5)))
    (LET ((INTERFACE-ARRAY
...
(DEFVAR *REQUESTS*
  (LET ((REQUESTS (CFFI:FOREIGN-ALLOC '(:STRUCT WL_MESSAGE) :COUNT 10)))
    (LET ((INTERFACE-ARRAY
           (CFFI:FOREIGN-ALLOC '(:POINTER (:POINTER :VOID)) :COUNT 10)))
      (SETF (MEM-AREF INTERFACE-ARRAY :POINTER 0) (NULL-POINTER))
      (SETF (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE)
             'BM-CL-LIBWAYLAND::NAME)
...
(DEFVAR *REQUESTS*
  (LET ((REQUESTS (CFFI:FOREIGN-ALLOC '(:STRUCT WL_MESSAGE) :COUNT 11)))
    (LET ((INTERFACE-ARRAY
           (CFFI:FOREIGN-ALLOC '(:POINTER (:POINTER :VOID)) :COUNT 11)))
      (SETF (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE)
             'BM-CL-LIBWAYLAND::NAME)
              (FOREIGN-STRING-ALLOC "destroy")
            (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE)
...
(DEFVAR *REQUESTS*
  (LET ((REQUESTS (CFFI:FOREIGN-ALLOC '(:STRUCT WL_MESSAGE) :COUNT 4)))
    (LET ((INTERFACE-ARRAY
...
(DEFVAR *REQUESTS*
  (LET ((REQUESTS (CFFI:FOREIGN-ALLOC '(:STRUCT WL_MESSAGE) :COUNT 6)))
    (LET ((INTERFACE-ARRAY
