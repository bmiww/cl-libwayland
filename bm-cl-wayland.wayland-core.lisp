(DEFPACKAGE :WL_DISPLAY
  ...
  (:EXPORT DISPATCH GLOBAL SYNC GET-REGISTRY))
...
(DEFPACKAGE :WL_COMPOSITOR
  ...
  (:EXPORT DISPATCH GLOBAL CREATE-SURFACE CREATE-REGION))
...
(DEFPACKAGE :WL_SHM_POOL
  ...
  (:EXPORT DISPATCH GLOBAL CREATE-BUFFER DESTROY RESIZE))
...
(DEFPACKAGE :WL_SHM
  (:USE :CL :WL :CFFI)
  (:NICKNAMES :WL-SHM)
  (:EXPORT DISPATCH GLOBAL CREATE-POOL))
...
(DEFPACKAGE :WL_BUFFER
  (:USE :CL :WL :CFFI)
  (:NICKNAMES :WL-BUFFER)
  (:EXPORT DISPATCH GLOBAL DESTROY))
...
(DEFPACKAGE :WL_DATA_OFFER
  ...
  (:EXPORT DISPATCH GLOBAL ACCEPT RECEIVE DESTROY FINISH SET-ACTIONS))
...
(DEFPACKAGE :WL_DATA_SOURCE
  ...
  (:EXPORT DISPATCH GLOBAL OFFER DESTROY SET-ACTIONS))
...
(DEFPACKAGE :WL_DATA_DEVICE
  ...
  (:EXPORT DISPATCH GLOBAL START-DRAG SET-SELECTION RELEASE))
...
(DEFPACKAGE :WL_DATA_DEVICE_MANAGER
  ...
  (:EXPORT DISPATCH GLOBAL CREATE-DATA-SOURCE GET-DATA-DEVICE))
...
(DEFPACKAGE :WL_SHELL
  (:USE :CL :WL :CFFI)
  (:NICKNAMES :WL-SHELL)
  (:EXPORT DISPATCH GLOBAL GET-SHELL-SURFACE))
...
(DEFPACKAGE :WL_SEAT
  (:USE :CL :WL :CFFI)
  (:NICKNAMES :WL-SEAT)
  (:EXPORT DISPATCH GLOBAL GET-POINTER GET-KEYBOARD GET-TOUCH RELEASE))
...
(DEFPACKAGE :WL_POINTER
  ...
  (:EXPORT DISPATCH GLOBAL SET-CURSOR RELEASE))
...
(DEFPACKAGE :WL_KEYBOARD
  ...
  (:EXPORT DISPATCH GLOBAL RELEASE))
...
(DEFPACKAGE :WL_REGION
  (:USE :CL :WL :CFFI)
  (:NICKNAMES :WL-REGION)
  (:EXPORT DISPATCH GLOBAL DESTROY ADD SUBTRACT))
...
(DEFPACKAGE :WL_SUBCOMPOSITOR
  ...
  (:EXPORT DISPATCH GLOBAL DESTROY GET-SUBSURFACE))
...
(DEFMETHOD DISPATCHER ((DISPATCH DISPATCH) OPCODE MESSAGE ARGS)
  (DEBUG-LOG! "Dispatching ~a~%" "wl_display")
  (DEBUG-LOG! "With arguments opcode: ~a, message: ~a, args: ~a~%" OPCODE
   MESSAGE ARGS)
...
(DEFMETHOD DISPATCHER ((DISPATCH DISPATCH) OPCODE MESSAGE ARGS)
  (DEBUG-LOG! "Dispatching ~a~%" "wl_registry")
  (DEBUG-LOG! "With arguments opcode: ~a, message: ~a, args: ~a~%" OPCODE
   MESSAGE ARGS)
  (ERROR "DISPATCHER NOT IMPLEMENTED"))
...
(DEFMETHOD DISPATCHER ((DISPATCH DISPATCH) OPCODE MESSAGE ARGS)
  (DEBUG-LOG! "Dispatching ~a~%" "wl_callback")
  (DEBUG-LOG! "With arguments opcode: ~a, message: ~a, args: ~a~%" OPCODE
   MESSAGE ARGS)
  (ERROR "DISPATCHER NOT IMPLEMENTED"))
...
(DEFMETHOD DISPATCHER ((DISPATCH DISPATCH) OPCODE MESSAGE ARGS)
  (DEBUG-LOG! "Dispatching ~a~%" "wl_compositor")
  (DEBUG-LOG! "With arguments opcode: ~a, message: ~a, args: ~a~%" OPCODE
   MESSAGE ARGS)
  (ERROR "DISPATCHER NOT IMPLEMENTED"))
...
(DEFMETHOD DISPATCHER ((DISPATCH DISPATCH) OPCODE MESSAGE ARGS)
  (DEBUG-LOG! "Dispatching ~a~%" "wl_shm_pool")
  (DEBUG-LOG! "With arguments opcode: ~a, message: ~a, args: ~a~%" OPCODE
   MESSAGE ARGS)
  (ERROR "DISPATCHER NOT IMPLEMENTED"))
...
(DEFMETHOD DISPATCHER ((DISPATCH DISPATCH) OPCODE MESSAGE ARGS)
  (DEBUG-LOG! "Dispatching ~a~%" "wl_shm")
  (DEBUG-LOG! "With arguments opcode: ~a, message: ~a, args: ~a~%" OPCODE
   MESSAGE ARGS)
  (ERROR "DISPATCHER NOT IMPLEMENTED"))
...
(DEFMETHOD DISPATCHER ((DISPATCH DISPATCH) OPCODE MESSAGE ARGS)
  (DEBUG-LOG! "Dispatching ~a~%" "wl_buffer")
  (DEBUG-LOG! "With arguments opcode: ~a, message: ~a, args: ~a~%" OPCODE
   MESSAGE ARGS)
  (ERROR "DISPATCHER NOT IMPLEMENTED"))
...
(DEFMETHOD DISPATCHER ((DISPATCH DISPATCH) OPCODE MESSAGE ARGS)
  (DEBUG-LOG! "Dispatching ~a~%" "wl_data_offer")
  (DEBUG-LOG! "With arguments opcode: ~a, message: ~a, args: ~a~%" OPCODE
   MESSAGE ARGS)
  (ERROR "DISPATCHER NOT IMPLEMENTED"))
...
(DEFMETHOD DISPATCHER ((DISPATCH DISPATCH) OPCODE MESSAGE ARGS)
  (DEBUG-LOG! "Dispatching ~a~%" "wl_data_source")
  (DEBUG-LOG! "With arguments opcode: ~a, message: ~a, args: ~a~%" OPCODE
   MESSAGE ARGS)
  (ERROR "DISPATCHER NOT IMPLEMENTED"))
...
(DEFMETHOD DISPATCHER ((DISPATCH DISPATCH) OPCODE MESSAGE ARGS)
  (DEBUG-LOG! "Dispatching ~a~%" "wl_data_device")
  (DEBUG-LOG! "With arguments opcode: ~a, message: ~a, args: ~a~%" OPCODE
   MESSAGE ARGS)
  (ERROR "DISPATCHER NOT IMPLEMENTED"))
...
(DEFMETHOD DISPATCHER ((DISPATCH DISPATCH) OPCODE MESSAGE ARGS)
  (DEBUG-LOG! "Dispatching ~a~%" "wl_data_device_manager")
  (DEBUG-LOG! "With arguments opcode: ~a, message: ~a, args: ~a~%" OPCODE
   MESSAGE ARGS)
  (ERROR "DISPATCHER NOT IMPLEMENTED"))
...
(DEFMETHOD DISPATCHER ((DISPATCH DISPATCH) OPCODE MESSAGE ARGS)
  (DEBUG-LOG! "Dispatching ~a~%" "wl_shell")
  (DEBUG-LOG! "With arguments opcode: ~a, message: ~a, args: ~a~%" OPCODE
   MESSAGE ARGS)
  (ERROR "DISPATCHER NOT IMPLEMENTED"))
...
(DEFMETHOD DISPATCHER ((DISPATCH DISPATCH) OPCODE MESSAGE ARGS)
  (DEBUG-LOG! "Dispatching ~a~%" "wl_shell_surface")
  (DEBUG-LOG! "With arguments opcode: ~a, message: ~a, args: ~a~%" OPCODE
   MESSAGE ARGS)
  (ERROR "DISPATCHER NOT IMPLEMENTED"))
...
(DEFMETHOD DISPATCHER ((DISPATCH DISPATCH) OPCODE MESSAGE ARGS)
  (DEBUG-LOG! "Dispatching ~a~%" "wl_surface")
  (DEBUG-LOG! "With arguments opcode: ~a, message: ~a, args: ~a~%" OPCODE
   MESSAGE ARGS)
  (ERROR "DISPATCHER NOT IMPLEMENTED"))
...
(DEFMETHOD DISPATCHER ((DISPATCH DISPATCH) OPCODE MESSAGE ARGS)
  (DEBUG-LOG! "Dispatching ~a~%" "wl_seat")
  (DEBUG-LOG! "With arguments opcode: ~a, message: ~a, args: ~a~%" OPCODE
   MESSAGE ARGS)
  (ERROR "DISPATCHER NOT IMPLEMENTED"))
...
(DEFMETHOD DISPATCHER ((DISPATCH DISPATCH) OPCODE MESSAGE ARGS)
  (DEBUG-LOG! "Dispatching ~a~%" "wl_pointer")
  (DEBUG-LOG! "With arguments opcode: ~a, message: ~a, args: ~a~%" OPCODE
   MESSAGE ARGS)
  (ERROR "DISPATCHER NOT IMPLEMENTED"))
...
(DEFMETHOD DISPATCHER ((DISPATCH DISPATCH) OPCODE MESSAGE ARGS)
  (DEBUG-LOG! "Dispatching ~a~%" "wl_keyboard")
  (DEBUG-LOG! "With arguments opcode: ~a, message: ~a, args: ~a~%" OPCODE
   MESSAGE ARGS)
  (ERROR "DISPATCHER NOT IMPLEMENTED"))
...
(DEFMETHOD DISPATCHER ((DISPATCH DISPATCH) OPCODE MESSAGE ARGS)
  (DEBUG-LOG! "Dispatching ~a~%" "wl_touch")
  (DEBUG-LOG! "With arguments opcode: ~a, message: ~a, args: ~a~%" OPCODE
   MESSAGE ARGS)
  (ERROR "DISPATCHER NOT IMPLEMENTED"))
...
(DEFMETHOD DISPATCHER ((DISPATCH DISPATCH) OPCODE MESSAGE ARGS)
  (DEBUG-LOG! "Dispatching ~a~%" "wl_output")
  (DEBUG-LOG! "With arguments opcode: ~a, message: ~a, args: ~a~%" OPCODE
   MESSAGE ARGS)
  (ERROR "DISPATCHER NOT IMPLEMENTED"))
...
(DEFMETHOD DISPATCHER ((DISPATCH DISPATCH) OPCODE MESSAGE ARGS)
  (DEBUG-LOG! "Dispatching ~a~%" "wl_region")
  (DEBUG-LOG! "With arguments opcode: ~a, message: ~a, args: ~a~%" OPCODE
   MESSAGE ARGS)
  (ERROR "DISPATCHER NOT IMPLEMENTED"))
...
(DEFMETHOD DISPATCHER ((DISPATCH DISPATCH) OPCODE MESSAGE ARGS)
  (DEBUG-LOG! "Dispatching ~a~%" "wl_subcompositor")
  (DEBUG-LOG! "With arguments opcode: ~a, message: ~a, args: ~a~%" OPCODE
   MESSAGE ARGS)
  (ERROR "DISPATCHER NOT IMPLEMENTED"))
...
(DEFMETHOD DISPATCHER ((DISPATCH DISPATCH) OPCODE MESSAGE ARGS)
  (DEBUG-LOG! "Dispatching ~a~%" "wl_subsurface")
  (DEBUG-LOG! "With arguments opcode: ~a, message: ~a, args: ~a~%" OPCODE
   MESSAGE ARGS)
  (ERROR "DISPATCHER NOT IMPLEMENTED"))
