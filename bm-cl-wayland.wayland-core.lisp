...
(PUSHNEW
 (LIST "wl_display" (LIST "wl_callback" "wl_registry")
       (LAMBDA ()
         ...
         (LET ((REQUESTS-PTR
                (LET ((MESSAGES
                       (CFFI:FOREIGN-ALLOC '(:STRUCT WL_MESSAGE) :COUNT 2)))
                  (LET ((INTERFACE-ARRAY
...
(DEFMETHOD SEND-ERROR
  ...
  (LET ((ARG-LIST (FOREIGN-ALLOC '(:UNION WL_ARGUMENT) :COUNT 3)))
    (SETF (FOREIGN-SLOT-VALUE
           ...
           '(:UNION BM-CL-LIBWAYLAND:WL_ARGUMENT) 'WL-FFI::O)
            (BM-CL-WAYLAND:PTR OBJECT_ID))
    (SETF (FOREIGN-SLOT-VALUE
    ...
    (SETF (FOREIGN-SLOT-VALUE
           ...
           '(:UNION BM-CL-LIBWAYLAND:WL_ARGUMENT) 'WL-FFI::S)
            MESSAGE)
 ...
 (LIST "wl_data_source" (LIST)
       (LAMBDA ()
         ...
         (LET ((REQUESTS-PTR
               ...
               (EVENTS-PTR
                (LET ((MESSAGES
                       (CFFI:FOREIGN-ALLOC '(:STRUCT WL_MESSAGE) :COUNT 6)))
                  (LET ((INTERFACE-ARRAY
                         (CFFI:FOREIGN-ALLOC '(:POINTER (:POINTER :VOID))
                                             :COUNT 1))
                        (MSG-PTR (MEM-APTR MESSAGES '(:STRUCT WL_MESSAGE) 0)))
...
(DEFMETHOD SEND-SEND
  ...
  (LET ((ARG-LIST (FOREIGN-ALLOC '(:UNION WL_ARGUMENT) :COUNT 2)))
    ...
    (SETF (FOREIGN-SLOT-VALUE
           (MEM-AREF ARG-LIST '(:UNION BM-CL-LIBWAYLAND:WL_ARGUMENT) 1)
           '(:UNION BM-CL-LIBWAYLAND:WL_ARGUMENT) 'WL-FFI::H)
            FD)
    (RESOURCE-POST-EVENT-ARRAY (PTR DISPATCH) 1 ARG-LIST)))
...
(DEFMETHOD SEND-DND-FINISHED ((DISPATCH DISPATCH))
  ...
  (LET ((ARG-LIST (FOREIGN-ALLOC '(:UNION WL_ARGUMENT) :COUNT 0)))
    (RESOURCE-POST-EVENT-ARRAY (PTR DISPATCH) 4 ARG-LIST)))
...
(DEFMETHOD SEND-ACTION ((DISPATCH DISPATCH) DND_ACTION)
  ...
  (LET ((ARG-LIST (FOREIGN-ALLOC '(:UNION WL_ARGUMENT) :COUNT 1)))
    (SETF (FOREIGN-SLOT-VALUE
           ...
           '(:UNION BM-CL-LIBWAYLAND:WL_ARGUMENT) 'WL-FFI::U)
            DND_ACTION)
    (RESOURCE-POST-EVENT-ARRAY (PTR DISPATCH) 5 ARG-LIST)))
...
(DEFMETHOD SEND-DATA-OFFER ((DISPATCH DISPATCH) ID)
  ...
  (LET ((ARG-LIST (FOREIGN-ALLOC '(:UNION WL_ARGUMENT) :COUNT 1)))
    (SETF (FOREIGN-SLOT-VALUE
           (MEM-AREF ARG-LIST '(:UNION BM-CL-LIBWAYLAND:WL_ARGUMENT) 0)
           '(:UNION BM-CL-LIBWAYLAND:WL_ARGUMENT) 'WL-FFI::N)
            ID)
    (RESOURCE-POST-EVENT-ARRAY (PTR DISPATCH) 0 ARG-LIST)))
...
(DEFMETHOD SEND-ENTER
  ...
  (LET ((ARG-LIST (FOREIGN-ALLOC '(:UNION WL_ARGUMENT) :COUNT 5)))
    ...
    (SETF (FOREIGN-SLOT-VALUE
           (MEM-AREF ARG-LIST '(:UNION BM-CL-LIBWAYLAND:WL_ARGUMENT) 1)
           '(:UNION BM-CL-LIBWAYLAND:WL_ARGUMENT) 'WL-FFI::O)
            (BM-CL-WAYLAND:PTR SURFACE))
    (SETF (FOREIGN-SLOT-VALUE
           (MEM-AREF ARG-LIST '(:UNION BM-CL-LIBWAYLAND:WL_ARGUMENT) 2)
           '(:UNION BM-CL-LIBWAYLAND:WL_ARGUMENT) 'WL-FFI::F)
            X)
    (SETF (FOREIGN-SLOT-VALUE
           ...
           '(:UNION BM-CL-LIBWAYLAND:WL_ARGUMENT) 'WL-FFI::F)
            Y)
    (SETF (FOREIGN-SLOT-VALUE
           (MEM-AREF ARG-LIST '(:UNION BM-CL-LIBWAYLAND:WL_ARGUMENT) 4)
           '(:UNION BM-CL-LIBWAYLAND:WL_ARGUMENT) 'WL-FFI::O)
            (BM-CL-WAYLAND:PTR ID))
    (RESOURCE-POST-EVENT-ARRAY (PTR DISPATCH) 1 ARG-LIST)))
...
(PUSHNEW
 (LIST "wl_surface" (LIST "wl_output" "wl_buffer" "wl_callback" "wl_region")
       (LAMBDA ()
         ...
         (LET ((REQUESTS-PTR
                (LET ((MESSAGES
                       (CFFI:FOREIGN-ALLOC '(:STRUCT WL_MESSAGE) :COUNT 11)))
                  (LET ((INTERFACE-ARRAY
                         (CFFI:FOREIGN-ALLOC '(:POINTER (:POINTER :VOID))
                                             :COUNT 0))
                        (MSG-PTR (MEM-APTR MESSAGES '(:STRUCT WL_MESSAGE) 0)))
...
(DEFMETHOD SEND-AXIS-SOURCE
  ...
  (LET ((ARG-LIST (FOREIGN-ALLOC '(:UNION WL_ARGUMENT) :COUNT 1)))
    (SETF (FOREIGN-SLOT-VALUE
           ...
           '(:UNION BM-CL-LIBWAYLAND:WL_ARGUMENT) 'WL-FFI::U)
            AXIS_SOURCE)
    (RESOURCE-POST-EVENT-ARRAY (PTR DISPATCH) 6 ARG-LIST)))
...
(DEFMETHOD SEND-AXIS-STOP
  ...
  (LET ((ARG-LIST (FOREIGN-ALLOC '(:UNION WL_ARGUMENT) :COUNT 2)))
    ...
    (SETF (FOREIGN-SLOT-VALUE
           ...
           '(:UNION BM-CL-LIBWAYLAND:WL_ARGUMENT) 'WL-FFI::U)
            AXIS)
    (RESOURCE-POST-EVENT-ARRAY (PTR DISPATCH) 7 ARG-LIST)))
...
(DEFMETHOD SEND-AXIS-DISCRETE
  ...
  (LET ((ARG-LIST (FOREIGN-ALLOC '(:UNION WL_ARGUMENT) :COUNT 2)))
    ...
    (SETF (FOREIGN-SLOT-VALUE
           ...
           '(:UNION BM-CL-LIBWAYLAND:WL_ARGUMENT) 'WL-FFI::I)
            DISCRETE)
    (RESOURCE-POST-EVENT-ARRAY (PTR DISPATCH) 8 ARG-LIST)))
...
(DEFMETHOD SEND-AXIS-VALUE120
  ...
  (LET ((ARG-LIST (FOREIGN-ALLOC '(:UNION WL_ARGUMENT) :COUNT 2)))
    ...
    (SETF (FOREIGN-SLOT-VALUE
           ...
           '(:UNION BM-CL-LIBWAYLAND:WL_ARGUMENT) 'WL-FFI::I)
            VALUE120)
    (RESOURCE-POST-EVENT-ARRAY (PTR DISPATCH) 9 ARG-LIST)))
...
(DEFMETHOD SEND-AXIS-RELATIVE-DIRECTION
  ...
  (LET ((ARG-LIST (FOREIGN-ALLOC '(:UNION WL_ARGUMENT) :COUNT 2)))
    ...
    (SETF (FOREIGN-SLOT-VALUE
           ...
           '(:UNION BM-CL-LIBWAYLAND:WL_ARGUMENT) 'WL-FFI::U)
            DIRECTION)
    (RESOURCE-POST-EVENT-ARRAY (PTR DISPATCH) 10 ARG-LIST)))
 ...
 (LIST "wl_touch" (LIST "wl_surface")
       (LAMBDA ()
         ...
         (LET ((REQUESTS-PTR
               ...
               (EVENTS-PTR
                (LET ((MESSAGES
                       (CFFI:FOREIGN-ALLOC '(:STRUCT WL_MESSAGE) :COUNT 7)))
                  (LET ((INTERFACE-ARRAY
                         (CFFI:FOREIGN-ALLOC '(:POINTER (:POINTER :VOID))
                                             :COUNT 6))
                        (MSG-PTR (MEM-APTR MESSAGES '(:STRUCT WL_MESSAGE) 0)))
  ...
  (LET ((ARG-LIST (FOREIGN-ALLOC '(:UNION WL_ARGUMENT) :COUNT 6)))
    ...
    (SETF (FOREIGN-SLOT-VALUE
           ...
           '(:UNION BM-CL-LIBWAYLAND:WL_ARGUMENT) 'WL-FFI::F)
            X)
    (SETF (FOREIGN-SLOT-VALUE
           (MEM-AREF ARG-LIST '(:UNION BM-CL-LIBWAYLAND:WL_ARGUMENT) 5)
           '(:UNION BM-CL-LIBWAYLAND:WL_ARGUMENT) 'WL-FFI::F)
            Y)
    (RESOURCE-POST-EVENT-ARRAY (PTR DISPATCH) 0 ARG-LIST)))
  ...
  (LET ((ARG-LIST (FOREIGN-ALLOC '(:UNION WL_ARGUMENT) :COUNT 8)))
    ...
    (SETF (FOREIGN-SLOT-VALUE
           ...
           '(:UNION BM-CL-LIBWAYLAND:WL_ARGUMENT) 'WL-FFI::S)
            MAKE)
    (SETF (FOREIGN-SLOT-VALUE
           (MEM-AREF ARG-LIST '(:UNION BM-CL-LIBWAYLAND:WL_ARGUMENT) 6)
           '(:UNION BM-CL-LIBWAYLAND:WL_ARGUMENT) 'WL-FFI::S)
            MODEL)
    (SETF (FOREIGN-SLOT-VALUE
           (MEM-AREF ARG-LIST '(:UNION BM-CL-LIBWAYLAND:WL_ARGUMENT) 7)
           '(:UNION BM-CL-LIBWAYLAND:WL_ARGUMENT) 'WL-FFI::U)
            TRANSFORM)
    (RESOURCE-POST-EVENT-ARRAY (PTR DISPATCH) 0 ARG-LIST)))
