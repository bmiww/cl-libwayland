...
(DEFVAR *REQUESTS*
  (LET ((REQUESTS (CFFI:FOREIGN-ALLOC '(:STRUCT WL_MESSAGE) 2)))
    ((LET ((INTERFACE-ARRAY
            (CFFI:FOREIGN-ALLOC '(:POINTER (:POINTER :VOID)) 2)))
       (SETF (MEM-AREF INTERFACE-ARRAY :POINTER 0) #:*INTERFACE*))
...
(DEFVAR *REQUESTS*
  (LET ((REQUESTS (CFFI:FOREIGN-ALLOC '(:STRUCT WL_MESSAGE) 1)))
    ((LET ((INTERFACE-ARRAY
            (CFFI:FOREIGN-ALLOC '(:POINTER (:POINTER :VOID)) 1)))
...
(DEFVAR *REQUESTS*
  (LET ((REQUESTS (CFFI:FOREIGN-ALLOC '(:STRUCT WL_MESSAGE) 3)))
    ((LET ((INTERFACE-ARRAY
            (CFFI:FOREIGN-ALLOC '(:POINTER (:POINTER :VOID)) 3)))
       (SETF (MEM-AREF INTERFACE-ARRAY :POINTER 0) #:*INTERFACE*)
       (SETF (MEM-AREF INTERFACE-ARRAY :POINTER 1) #:*INTERFACE*)
       (SETF (MEM-AREF INTERFACE-ARRAY :POINTER 2) #:*INTERFACE*)
       (SETF (MEM-AREF INTERFACE-ARRAY :POINTER 3) (NULL-POINTER)))
     (SETF (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'NAME)
             (FOREIGN-STRING-ALLOC (NAME REQUEST))
           (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'SIGNATURE)
...
(DEFVAR *REQUESTS*
  (LET ((REQUESTS (CFFI:FOREIGN-ALLOC '(:STRUCT WL_MESSAGE) 6)))
    ((LET ((INTERFACE-ARRAY
            (CFFI:FOREIGN-ALLOC '(:POINTER (:POINTER :VOID)) 6))))
     (SETF (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'NAME)
             (FOREIGN-STRING-ALLOC (NAME REQUEST))
           (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'SIGNATURE)
             (FOREIGN-STRING-ALLOC "")
