...
(DEFVAR *REQUESTS*
  (LET ((REQUESTS (CFFI:FOREIGN-ALLOC '(:STRUCT WL_MESSAGE) 2)))
    (LET ((INTERFACE-ARRAY (CFFI:FOREIGN-ALLOC '(:POINTER (:POINTER :VOID)) 2)))
      (SETF (MEM-AREF INTERFACE-ARRAY :POINTER 0) WL/WL_CALLBACK::*INTERFACE*)
      (SETF (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'NAME)
            ...
            (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'TYPES)
              INTERFACE-ARRAY))
    (LET ((INTERFACE-ARRAY (CFFI:FOREIGN-ALLOC '(:POINTER (:POINTER :VOID)) 2)))
      (SETF (MEM-AREF INTERFACE-ARRAY :POINTER 0) WL/WL_REGISTRY::*INTERFACE*)
      (SETF (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'NAME)
...
(SETF (FOREIGN-SLOT-VALUE INTERFACE '(:STRUCT INTERFACE) 'REQUEST-COUNT) 2)

(SETF (FOREIGN-SLOT-VALUE INTERFACE '(:STRUCT INTERFACE) 'REQUESTS) *REQUESTS*)

(SETF (FOREIGN-SLOT-VALUE INTERFACE '(:STRUCT INTERFACE) 'EVENT-COUNT) 2)
...
(DEFVAR *REQUESTS*
  (LET ((REQUESTS (CFFI:FOREIGN-ALLOC '(:STRUCT WL_MESSAGE) 1)))
    (LET ((INTERFACE-ARRAY (CFFI:FOREIGN-ALLOC '(:POINTER (:POINTER :VOID)) 1)))
...
(SETF (FOREIGN-SLOT-VALUE INTERFACE '(:STRUCT INTERFACE) 'REQUEST-COUNT) 1)
...
(DEFVAR *REQUESTS*
  (LET ((REQUESTS (CFFI:FOREIGN-ALLOC '(:STRUCT WL_MESSAGE) 0)))
    REQUESTS))
...
(SETF (FOREIGN-SLOT-VALUE INTERFACE '(:STRUCT INTERFACE) 'REQUEST-COUNT) 0)
...
(DEFVAR *REQUESTS*
  (LET ((REQUESTS (CFFI:FOREIGN-ALLOC '(:STRUCT WL_MESSAGE) 2)))
    (LET ((INTERFACE-ARRAY (CFFI:FOREIGN-ALLOC '(:POINTER (:POINTER :VOID)) 2)))
      (SETF (MEM-AREF INTERFACE-ARRAY :POINTER 0) WL/WL_SURFACE::*INTERFACE*)
      (SETF (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'NAME)
            ...
            (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'TYPES)
              INTERFACE-ARRAY))
    (LET ((INTERFACE-ARRAY (CFFI:FOREIGN-ALLOC '(:POINTER (:POINTER :VOID)) 2)))
      (SETF (MEM-AREF INTERFACE-ARRAY :POINTER 0) WL/WL_REGION::*INTERFACE*)
      (SETF (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'NAME)
...
(DEFVAR *REQUESTS*
  (LET ((REQUESTS (CFFI:FOREIGN-ALLOC '(:STRUCT WL_MESSAGE) 3)))
    (LET ((INTERFACE-ARRAY (CFFI:FOREIGN-ALLOC '(:POINTER (:POINTER :VOID)) 3)))
      (SETF (MEM-AREF INTERFACE-ARRAY :POINTER 0) WL/WL_BUFFER::*INTERFACE*)
      (SETF (MEM-AREF INTERFACE-ARRAY :POINTER 1) (NULL-POINTER))
...
(DEFVAR *REQUESTS*
  (LET ((REQUESTS (CFFI:FOREIGN-ALLOC '(:STRUCT WL_MESSAGE) 1)))
    (LET ((INTERFACE-ARRAY (CFFI:FOREIGN-ALLOC '(:POINTER (:POINTER :VOID)) 1)))
      (SETF (MEM-AREF INTERFACE-ARRAY :POINTER 0) WL/WL_SHM_POOL::*INTERFACE*)
      (SETF (MEM-AREF INTERFACE-ARRAY :POINTER 1) (NULL-POINTER))
      (SETF (MEM-AREF INTERFACE-ARRAY :POINTER 2) (NULL-POINTER))
      (SETF (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'NAME)
...
(DEFVAR *REQUESTS*
  (LET ((REQUESTS (CFFI:FOREIGN-ALLOC '(:STRUCT WL_MESSAGE) 5)))
    (LET ((INTERFACE-ARRAY (CFFI:FOREIGN-ALLOC '(:POINTER (:POINTER :VOID)) 5)))
      (SETF (MEM-AREF INTERFACE-ARRAY :POINTER 0) (NULL-POINTER))
      (SETF (MEM-AREF INTERFACE-ARRAY :POINTER 1) (NULL-POINTER))
      (SETF (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'NAME)
...
(SETF (FOREIGN-SLOT-VALUE INTERFACE '(:STRUCT INTERFACE) 'EVENT-COUNT) 6)
  ...
  (LET ((REQUESTS (CFFI:FOREIGN-ALLOC '(:STRUCT WL_MESSAGE) 3)))
    (LET ((INTERFACE-ARRAY (CFFI:FOREIGN-ALLOC '(:POINTER (:POINTER :VOID)) 3)))
      (SETF (MEM-AREF INTERFACE-ARRAY :POINTER 0)
              WL/WL_DATA_SOURCE::*INTERFACE*)
      (SETF (MEM-AREF INTERFACE-ARRAY :POINTER 1) WL/WL_SURFACE::*INTERFACE*)
      (SETF (MEM-AREF INTERFACE-ARRAY :POINTER 2) WL/WL_SURFACE::*INTERFACE*)
      (SETF (MEM-AREF INTERFACE-ARRAY :POINTER 3) (NULL-POINTER))
      (SETF (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'NAME)
...
(DEFVAR *REQUESTS*
  (LET ((REQUESTS (CFFI:FOREIGN-ALLOC '(:STRUCT WL_MESSAGE) 2)))
    ...
    (LET ((INTERFACE-ARRAY (CFFI:FOREIGN-ALLOC '(:POINTER (:POINTER :VOID)) 2)))
      (SETF (MEM-AREF INTERFACE-ARRAY :POINTER 0)
              WL/WL_DATA_DEVICE::*INTERFACE*)
      (SETF (MEM-AREF INTERFACE-ARRAY :POINTER 1) WL/WL_SEAT::*INTERFACE*)
      (SETF (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'NAME)
...
(DEFVAR *REQUESTS*
  (LET ((REQUESTS (CFFI:FOREIGN-ALLOC '(:STRUCT WL_MESSAGE) 10)))
    ...
    (LET ((INTERFACE-ARRAY
           (CFFI:FOREIGN-ALLOC '(:POINTER (:POINTER :VOID)) 10)))
      (SETF (MEM-AREF INTERFACE-ARRAY :POINTER 0) WL/WL_SEAT::*INTERFACE*)
      (SETF (MEM-AREF INTERFACE-ARRAY :POINTER 1) (NULL-POINTER))
      (SETF (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'NAME)
    ...
    (LET ((INTERFACE-ARRAY
      ...
      (SETF (MEM-AREF INTERFACE-ARRAY :POINTER 0) (NULL-POINTER))
      (SETF (MEM-AREF INTERFACE-ARRAY :POINTER 1) (NULL-POINTER))
      (SETF (MEM-AREF INTERFACE-ARRAY :POINTER 2) WL/WL_OUTPUT::*INTERFACE*)
      (SETF (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'NAME)
    ...
    (LET ((INTERFACE-ARRAY
           (CFFI:FOREIGN-ALLOC '(:POINTER (:POINTER :VOID)) 10)))
      (SETF (MEM-AREF INTERFACE-ARRAY :POINTER 0) WL/WL_OUTPUT::*INTERFACE*)
      (SETF (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'NAME)
...
(DEFVAR *REQUESTS*
  (LET ((REQUESTS (CFFI:FOREIGN-ALLOC '(:STRUCT WL_MESSAGE) 11)))
    (LET ((INTERFACE-ARRAY
           (CFFI:FOREIGN-ALLOC '(:POINTER (:POINTER :VOID)) 11)))
      (SETF (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'NAME)
              (FOREIGN-STRING-ALLOC "destroy")
            (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'SIGNATURE)
              (FOREIGN-STRING-ALLOC "")
...
(SETF (FOREIGN-SLOT-VALUE INTERFACE '(:STRUCT INTERFACE) 'REQUEST-COUNT) 11)
...
(SETF (FOREIGN-SLOT-VALUE INTERFACE '(:STRUCT INTERFACE) 'SET_BUFFER_TRANSFORM)
...
(DEFVAR *REQUESTS*
  (LET ((REQUESTS (CFFI:FOREIGN-ALLOC '(:STRUCT WL_MESSAGE) 4)))
    (LET ((INTERFACE-ARRAY (CFFI:FOREIGN-ALLOC '(:POINTER (:POINTER :VOID)) 4)))
      (SETF (MEM-AREF INTERFACE-ARRAY :POINTER 0) WL/WL_POINTER::*INTERFACE*)
      (SETF (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'NAME)
            ...
            (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'TYPES)
              INTERFACE-ARRAY))
    (LET ((INTERFACE-ARRAY (CFFI:FOREIGN-ALLOC '(:POINTER (:POINTER :VOID)) 4)))
      (SETF (MEM-AREF INTERFACE-ARRAY :POINTER 0) WL/WL_KEYBOARD::*INTERFACE*)
      (SETF (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'NAME)
            ...
            (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'TYPES)
              INTERFACE-ARRAY))
    (LET ((INTERFACE-ARRAY (CFFI:FOREIGN-ALLOC '(:POINTER (:POINTER :VOID)) 4)))
      (SETF (MEM-AREF INTERFACE-ARRAY :POINTER 0) WL/WL_TOUCH::*INTERFACE*)
      (SETF (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'NAME)
...
(SETF (FOREIGN-SLOT-VALUE INTERFACE '(:STRUCT INTERFACE) 'EVENT-COUNT) 11)
...
(SETF (FOREIGN-SLOT-VALUE INTERFACE '(:STRUCT INTERFACE) 'EVENT-COUNT) 7)
...
(DEFVAR *REQUESTS*
  (LET ((REQUESTS (CFFI:FOREIGN-ALLOC '(:STRUCT WL_MESSAGE) 6)))
    (LET ((INTERFACE-ARRAY (CFFI:FOREIGN-ALLOC '(:POINTER (:POINTER :VOID)) 6)))
      (SETF (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'NAME)
              (FOREIGN-STRING-ALLOC "destroy")
            (FOREIGN-SLOT-VALUE REQUESTS '(:STRUCT WL_MESSAGE) 'SIGNATURE)
              (FOREIGN-STRING-ALLOC "")
...
(SETF (FOREIGN-SLOT-VALUE INTERFACE '(:STRUCT INTERFACE) 'REQUEST-COUNT) 6)
