...
(DEFMETHOD CL-WL:DESTROY :AFTER ((DISPATCH DISPATCH))
  (CL-WL::DEBUG-LOG! "Destroying dispatch object: ~a~%" "zwp_linux_dmabuf_v1")
  (WHEN (SLOT-BOUNDP DISPATCH 'CL-WL:DESTROY)
    (FUNCALL (SLOT-VALUE DISPATCH 'CL-WL:DESTROY) DISPATCH))
  (LET ((RESOURCE-PTR (ZWP_LINUX_DMABUF_V1-PTR DISPATCH)))
...
(DEFCALLBACK DISPATCHER-FFI :INT
 ...
 (LET ((RESOURCE (GETHASH (POINTER-ADDRESS TARGET) CL-WL::*RESOURCE-TRACKER*)))
   (ECASE OPCODE
     (0
      (CL-WL::DEBUG-LOG! "Dispatching ~a:~a~%" "zwp_linux_dmabuf_v1" "destroy")
      (FUNCALL 'DESTROY RESOURCE))
     (1
      (CL-WL::DEBUG-LOG! "Dispatching ~a:~a~%" "zwp_linux_dmabuf_v1"
                         "create-params")
...
(DEFMETHOD CL-WL:DESTROY :AFTER ((DISPATCH DISPATCH))
  ...
  (WHEN (SLOT-BOUNDP DISPATCH 'CL-WL:DESTROY)
    (FUNCALL (SLOT-VALUE DISPATCH 'CL-WL:DESTROY) DISPATCH))
  (LET ((RESOURCE-PTR (ZWP_LINUX_BUFFER_PARAMS_V1-PTR DISPATCH)))
    (REMHASH (POINTER-ADDRESS RESOURCE-PTR) CL-WL::*RESOURCE-TRACKER*)))
...
(DEFCALLBACK DISPATCHER-FFI :INT
 ...
 (LET ((RESOURCE (GETHASH (POINTER-ADDRESS TARGET) CL-WL::*RESOURCE-TRACKER*)))
   (ECASE OPCODE
     (0
      (CL-WL::DEBUG-LOG! "Dispatching ~a:~a~%" "zwp_linux_buffer_params_v1"
                         "destroy")
      (FUNCALL 'DESTROY RESOURCE))
     (1
      (CL-WL::DEBUG-LOG! "Dispatching ~a:~a~%" "zwp_linux_buffer_params_v1"
...
(DEFMETHOD CL-WL:DESTROY :AFTER ((DISPATCH DISPATCH))
  ...
  (WHEN (SLOT-BOUNDP DISPATCH 'CL-WL:DESTROY)
    (FUNCALL (SLOT-VALUE DISPATCH 'CL-WL:DESTROY) DISPATCH))
  (LET ((RESOURCE-PTR (ZWP_LINUX_DMABUF_FEEDBACK_V1-PTR DISPATCH)))
    (REMHASH (POINTER-ADDRESS RESOURCE-PTR) CL-WL::*RESOURCE-TRACKER*)))
...
(DEFCALLBACK DISPATCHER-FFI :INT
 ...
 (LET ((RESOURCE (GETHASH (POINTER-ADDRESS TARGET) CL-WL::*RESOURCE-TRACKER*)))
   (ECASE OPCODE
     (0
      (CL-WL::DEBUG-LOG! "Dispatching ~a:~a~%" "zwp_linux_dmabuf_feedback_v1"
                         "destroy")
      (FUNCALL 'DESTROY RESOURCE))))
 0)
